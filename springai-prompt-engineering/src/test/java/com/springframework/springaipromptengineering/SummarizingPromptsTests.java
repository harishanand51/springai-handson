package com.springframework.springaipromptengineering;
...
public class SummarizingPromptsTests extends BaseTestClass {
    ...
    void testCreateDescriptionFrom3Reviews() {
    	...
    	PromptTemplate promptTemplate = new PromptTemplate(reviewPrompt3, Map.of("review", review1, "review2", review2, "review3", review3));
    ...
    void testCreateDescriptionFrom3ReviewsExtract() {
        ...
        PromptTemplate promptTemplate = new PromptTemplate(reviewPrompt4, Map.of("review", review1, "review2", review2, "review3", review3));
